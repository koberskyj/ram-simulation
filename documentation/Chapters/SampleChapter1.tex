...
Stroj popsal v roce 1936 Alan Turing a od té doby je to jeden z klíčových formálních nástrojů pro
 definici pojmu \texttt{algoritmus} a pro charakterizaci rekurzivně vyčíslitelných jazyků. % TODO cite https://www.geeksforgeeks.org/turing-machine-in-toc/
Je na něm postavena \textbf{Churchova-Turingova teze}, podle které může být každý algoritmus realizován Turingovým strojem. 
Programovací jazyky a stroje, které umožňují vyjádřit libovolný takovýto algoritmus, se označují jako \textbf{Turingovsky úplné}. % TODO https://www.cs.vsb.cz/sawa/ti/slides/ti-slides-01.pdf
...
Formálně je Turingův stroj definován jako šestice $M = (Q, \Sigma, \Gamma, \delta, q_0, F)$, kde: % TODO https://www.cs.vsb.cz/sawa/ti/slides/ti-slides-01.pdf
\begin{itemize}
...
% TODO https://www.cs.vsb.cz/sawa/ti/slides/ti-slides-01.pdf
\begin{itemize}
	\item $R_i := c$
	\item $R_i := R_j$
	\item $R_i := [R_j]$
